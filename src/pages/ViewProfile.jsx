...
const ViewProfile = () => {
  ...
  // 1. Hide employer identity unless status is 'hired'
  // (Assume employer details are only shown if jobSeeker.employerRequestStatus === 'hired')
  // 2. Show/hide action buttons based on workflow status and user role
  const canRequestCandidate = !user || (user?.role === 'employer' && (!jobSeeker?.employerRequestStatus || jobSeeker?.employerRequestStatus === 'completed'));
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                  <div className="flex-1">
                    ...
                    {isPublic && jobSeeker.approvalStatus && (
                      <div className="mb-4">
                        <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium ${jobSeeker.approvalStatus === 'approved'
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }}>
              <Card className="p-6 bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg border-0 sticky top-6">
                ...
                <div className="space-y-3">
                  ...
                  {/* TODO: Add candidate notification display here */}
                </div>
              </Card>
            </motion.div>
          </div>
