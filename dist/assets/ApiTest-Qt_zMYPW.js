import{r as c,j as s}from"./vendor-react-Ciyz3SKt.js";import{A as d,b as p}from"./index-r2M3Ub8S.js";import{E as r}from"./endpoints-CXiMw_A_.js";const E=()=>{const[i,l]=c.useState(""),[o,n]=c.useState(!1),h=()=>{l(`
...
- Full URL: ${d.BASE_URL}${r.EMPLOYER.LOGIN}
    `)},g=async()=>{n(!0);try{console.log("🧪 Testing API call...");const e=await p.get("/health");l(t=>t+`

✅ API Call Success:
`+JSON.stringify(e,null,2))}catch(e){console.error("❌ API call failed:",e),l(t=>t+`

❌ API Call Failed:
`+JSON.stringify(e,null,2))}finally{n(!1)}},m=async()=>{n(!0);try{console.log("🧪 Testing employer login...");const e=await p.post(r.EMPLOYER.LOGIN,{email:"test@example.com",password:"test123"});l(t=>t+`
